...
- Functions: aim for at most 80 lines. Exceed 80 only when keeping the logic
  together is clearer and the function remains cohesive and easy to understand.
  Prefer meaningful structure over forcing short functions or short lines.
...
- Every folder must contain a short `README.md`.
- Briefly describe the folder's purpose and each file inside it.
- Keep these descriptions concise and update them when files change.
