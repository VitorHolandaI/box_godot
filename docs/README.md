...
Documentacao detalhada do Box Godot. O `README.md` na raiz fica so com o
essencial (o que e, como rodar, controles) e aponta para ca.
...
| `tick-rede-60hz.md` | como a fisica e os snapshots do servidor dedicado chegaram a 60 Hz: alavancas, `fmod` do acumulador, medicoes (local e VPS), por que 120 Hz foi descartado e as armadilhas |
