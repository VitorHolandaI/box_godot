...
- `bullet.tscn`: projetil visual e autoritativo.
...
- `test_combat_and_variants.tscn`: runner headless para testes unitarios de combate, fogo amigo, flinch e variantes de zumbis.
