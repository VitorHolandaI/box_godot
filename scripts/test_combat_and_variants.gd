...
const NETWORK_CHANNELS_TESTS_SCRIPT := preload("res://scripts/test_network_channels.gd")
...
const FOCUSED_TEST_GROUPS := {
	...
	"network_channels": NETWORK_CHANNELS_TESTS_SCRIPT,
...
func _ready() -> void:
	...
	NETWORK_CHANNELS_TESTS_SCRIPT.new().run(self)
