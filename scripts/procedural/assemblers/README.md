...
- `building_assembler.gd`: monta casas com telhado, paredes internas, portas com nome deterministico, moveis por comodo (cama, geladeira, fogao, quadro e banheiro), ar-condicionado externo, luzes, apartamentos, o navmesh do edificio e ancoras de loot internas (grupo `building_loot_points`) usadas para espalhar municao/arma dentro dos predios.
