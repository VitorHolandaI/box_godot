...
const RESTOCKED_KINDS: Array[int] = [
	...
	GroundSupplyPickup.Kind.EQUIP_GRENADES,
	GroundSupplyPickup.Kind.EQUIP_KNIVES,
]
...
const AMOUNT_BY_KIND: Dictionary = {
	...
	GroundSupplyPickup.Kind.EQUIP_GRENADES: 2,
	GroundSupplyPickup.Kind.EQUIP_KNIVES: 3,
}
