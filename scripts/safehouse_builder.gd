...
const ROOF_BUILDER_SCRIPT: GDScript = preload("res://scripts/safehouse_roof_builder.gd")
# Altura ate o telhado + mureta: o navmesh inclui o telhado (quem esta la em
# cima continua alcancavel pela rampa interna).
const NAVIGATION_SIZE := Vector3(12.8, 8.4, 12.8)
...
static func build_safehouse() -> StaticBody3D:
	...
	ROOF_BUILDER_SCRIPT.build(house, cutout_wall_mat, cutout_floor_mat, wood_mat)
